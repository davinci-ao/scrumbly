...
Route::get('/{slug}', [ProjectController::class, 'projectIndex'])->middleware(['auth'])->name('projectIndex');
Route::get('/project/{project_id}', [ProjectController::class, 'projectUpdate'])->middleware(['auth'])->name('projectUpdate');
